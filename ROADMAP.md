...
The following items were originally listed alongside v1.2 but are **not part of the v1.2 foundation scope** — they target v1.4 and later:

- Multi-node discovery (mDNS — full implementation) *(v1.4+)*
- Plugin system for custom routing strategies *(v1.4+)*
